...
class ApiServiceImpl extends ApiService{
  ...
  @override
  Future<Map<String, dynamic>> get(String endPoint, Map<String, String> data) async {
    Response response = await _dio.get(baseUrl+endPoint, options: Options(headers: data));
